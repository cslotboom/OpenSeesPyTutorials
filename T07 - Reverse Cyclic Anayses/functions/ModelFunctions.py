...
def getSections():
    ...
    # rebarY = np.array([-150, -225, 150, 225])*mm
    rebarY = np.array([-225, 150, 225])*mm
...
def buildModel():   
    ...
    op.element('forceBeamColumn', 1, *[1,2], 1, 2, '-iter', 50, 1e-10)
    op.element('forceBeamColumn', 2, *[2,3], 1, 2, '-iter', 50, 1e-10)
    op.element('forceBeamColumn', 3, *[3,4], 1, 2, '-iter', 50, 1e-10)
