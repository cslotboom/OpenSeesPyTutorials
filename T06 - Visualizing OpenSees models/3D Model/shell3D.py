...
opp.plot_model('nodes', 'element', Model = ModelName)
opp.plot_modeshape(2, 200, Model = ModelName)

opp.plot_deformedshape(ModelName, LoadCaseName, scale = 200, tstep = .512341234, overlap = 'yes')

ani = opp.animate_deformedshape(ModelName, LoadCaseName2, dt = 1/24, scale=200)
